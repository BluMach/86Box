...
#if (defined __SSE__ || defined __x86_64__ || defined _M_X64 || (defined(_M_IX86_FP) && (_M_IX86_FP >= 1))) && !defined(IMGUI_DISABLE_SSE) && !defined(_M_ARM64) && !defined(_M_ARM64EC) && !(defined(__riscv) && (__SIZEOF_POINTER__ == 8)) && !defined(__loongarch_lp64)
