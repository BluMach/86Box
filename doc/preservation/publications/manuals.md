...
| TriGem SX386M / Emerson Elite SX386/16 | Independent board and BIOS preservation | [VOGONS](https://www.vogons.org/viewtopic.php?t=86204) | Primary evidence for the unrelated TriGem platform. Its HT101SX/HT113/GC102 population and firmware-visible `1ECh-1EFh` interface are useful comparative chipset evidence for PCS 386SX, not evidence of an OEM or product relationship. |
...
| Epson CW3S16 | 218-page Canadian-product manual scan record | [Manualzilla](https://manualzilla.com/doc/7429223/epson-cw3s16-canadian-product-specifications) | Link and partial-text metadata only. The scan has not yet supplied authoritative board photographs or a BIOS dump, and must not be confused with the CW3S20/C guide. |
| Epson CW3S20/C / TriGem SX386MC | *SX386MC Operations Guide*, 220 pages, copyright 1990 TriGem | [Epson support](https://files.support.epson.com/pdf/cw3s2c/cw3s2cu1.pdf) | Primary manual for a different 20 MHz cached TriGem system. Documents 2-32 MB, 32 KB cache, MS-DOS 4.01, supplied media, `TGSS.COM`, connectors, memory populations and ROM diagnostics; not the 16 MHz KS-II specification. |
| M300-30 / M300-30P | Olivetti Pocket Service Guide, Systems 1, chapter 36 | [Ardent Tool archive](https://www.ardent-tool.com/Olivetti/Docs/service_guide/systems1/cap36.pdf) | CPU variants, memory populations, board architecture, integrated video and service information. Linked only; redistribution rights have not been established. |
| M300-30 / M300-30P | VLSI VL82C486 system-controller documentation | Archival component-data-sheet holding | Register and split-memory behaviour used to check the initial chipset model; do not mirror without a rights review. |
| M300-30 / M300-30P | Western Digital WD90C31 technical reference | Archival component-data-sheet holding | Identifies the real integrated graphics controller and the boundary of the compatible WD90C30-based implementation. |
